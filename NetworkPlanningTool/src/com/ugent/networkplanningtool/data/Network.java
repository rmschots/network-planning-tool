...
public enum Network {
	...
	NETWORK_D(MainActivity.getContext().getResources().getString(R.string.networkDText),Color.rgb(115, 128, 190)),
	NETWORK_E(MainActivity.getContext().getResources().getString(R.string.networkEText),Color.rgb(115, 128, 190)),
	NETWORK_F(MainActivity.getContext().getResources().getString(R.string.networkFText),Color.rgb(115, 128, 190)),
	NETWORK_G(MainActivity.getContext().getResources().getString(R.string.networkGText),Color.rgb(115, 128, 190)),
	NETWORK_H(MainActivity.getContext().getResources().getString(R.string.networkHText),Color.rgb(115, 128, 190));
